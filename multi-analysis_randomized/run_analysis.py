...
#Nevere use it if you do not want to change the initial state you have used until now, save a copy of it before. init_state_gen(full_res, nobs_max, directories['multi'])
