...
\end{align}
Interpolators in model and control spaces are linked via the $\mathbf{B}$ matrix square-root adjoint.
\end{enumerate}
...
\begin{itemize}
\item Inconsistent case: both conditions 1. and 2. are required since the full resolution guess and the first term of the right-hand side are computed independently.
\item Consistent case: condition 2. is sufficient, since the full resolution guess is computed consistently with the first term of the right-hand side.
\end{itemize}
