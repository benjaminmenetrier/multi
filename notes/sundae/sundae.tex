...
\begin{figure}
  \begin{minipage}[c]{0.67\textwidth}
    \includegraphics[scale=0.3]{img/full_res/compare_j_nl.png}
  \end{minipage}\hfill
...
\begin{figure}
  \begin{minipage}[c]{0.67\textwidth}
    \includegraphics[scale=0.3]{img/full_res/compare_j.png}
  \end{minipage}\hfill
...
\begin{figure}
  \begin{minipage}[c]{0.67\textwidth}
    \includegraphics[scale=0.3]{img/11-31-51-101-Linear/sp/T/compare_j_nl.png}
  \end{minipage}\hfill
  \begin{minipage}[c]{0.23\textwidth}
...
\begin{figure}
  \begin{minipage}[c]{0.67\textwidth}
    \includegraphics[scale=0.3]{img/11-31-51-101-nl/T/sp/compare_j_nl.png}
  \end{minipage}\hfill
  \begin{minipage}[c]{0.23\textwidth}
...
\begin{figure}
  \begin{minipage}[c]{0.48\textwidth}
    \includegraphics[scale=0.25]{img/11-31-51-101-nl/T/bi/compare_j_nl.png}
    \caption{same figure as figure \ref{fig:jnlsp} but using a bilinear interpolation between the outer loops}
  \end{minipage}\hfill
  \begin{minipage}[c]{0.48\textwidth}
  \includegraphics[scale=0.25]{img/11-31-51-101-nl/T/near/compare_j_nl.png}
...
\begin{figure}
  \begin{minipage}[c]{0.67\textwidth}
    \includegraphics[scale=0.3]{img/11-31-51-101-nl/F/sp/compare_j_nl.png}
  \end{minipage}\hfill
  \begin{minipage}[c]{0.23\textwidth}
...
\begin{figure}
  \begin{minipage}[c]{0.48\textwidth}
    \includegraphics[scale=0.25]{img/11-31-51-101-nl/F/bi/compare_j_nl.png}
    \caption{same figure as  but using a bilinear interpolation between the outer loops and a non projective $\mathbf{B}$ matrix}
  \end{minipage}\hfill
  \begin{minipage}[c]{0.48\textwidth}
  \includegraphics[scale=0.25]{img/11-31-51-101-nl/F/near/compare_j_nl.png}
