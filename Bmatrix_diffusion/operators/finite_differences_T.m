%function T = finite_differences(ell_tild,N,BC_type)
...
function T = finite_differences_T(ell_tild,N,BC_type)


%Diagonal elements
line_indices=1:N;
column_indices=1:N;
T = sparse(line_indices,column_indices,(1+2*ell_tild^2)*ones(N,1),N,N);

%Sub-diagonal elements
line_indices=1:N-1;
column_indices=2:N;
T = T + sparse(line_indices,column_indices,-ell_tild^2*ones((N-1),1),N,N);
