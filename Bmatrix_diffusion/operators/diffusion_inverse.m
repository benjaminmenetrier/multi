%function output=diffusion_inverse(param_diff,input)
%This operator isthe inverse of a diffusion-based covariance operator 
%of parameters param_diff.
